<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="申请数量" prop="shenqingshuliang">
          <el-input v-model="ruleForm.shenqingshuliang" 
              placeholder="申请数量" clearable  :readonly="ro.shenqingshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="申请数量" prop="shenqingshuliang">
              <el-input v-model="ruleForm.shenqingshuliang" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wuzifenlei = true;
          ...
          if(o=='shenqingshuliang'){
            this.ruleForm.shenqingshuliang = obj[o];
	    this.ro.shenqingshuliang = true;
            continue;
          }
