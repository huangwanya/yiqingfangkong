<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.wuzifengmian" label="物资封面" prop="wuzifengmian">
          <file-upload
          tip="点击上传物资封面"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.wuzifengmian?ruleForm.wuzifengmian:''"
          @change="wuzifengmianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.wuzifengmian" label="物资封面" prop="wuzifengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.wuzifengmian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="储存位置" prop="chucunweizhi">
          <el-input v-model="ruleForm.chucunweizhi" 
              placeholder="储存位置" clearable  :readonly="ro.chucunweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="储存位置" prop="chucunweizhi">
              <el-input v-model="ruleForm.chucunweizhi" 
                placeholder="储存位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="物资简介" prop="wuzijianjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="物资简介"
                  v-model="ruleForm.wuzijianjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wuzijianjie" label="物资简介" prop="wuzijianjie">
                    <span>{{ruleForm.wuzijianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	wuzijianjie : false,
      ...
      rules: {
          ...
          chucunweizhi: [
                { required: true, message: '储存位置不能为空', trigger: 'blur' },
          ],
          beizhu: [
          ],
          wuzijianjie: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wuzimingcheng = true;
          ...
          if(o=='wuzifengmian'){
            this.ruleForm.wuzifengmian = obj[o];
	    this.ro.wuzifengmian = true;
            continue;
          }
          if(o=='wuzifenlei'){
	    ...
	    this.ro.beizhu = true;
          ...
          if(o=='wuzijianjie'){
            this.ruleForm.wuzijianjie = obj[o];
	    this.ro.wuzijianjie = true;
            continue;
          }
        }
      }
	...
	if(this.ruleForm.wuzifengmian!=null) {
		this.ruleForm.wuzifengmian = this.ruleForm.wuzifengmian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    wuzifengmianUploadChange(fileUrls) {
	this.ruleForm.wuzifengmian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
