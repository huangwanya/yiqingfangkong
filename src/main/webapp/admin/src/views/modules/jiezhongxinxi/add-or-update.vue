<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接种名称" prop="jiezhongmingcheng">
          <el-input v-model="ruleForm.jiezhongmingcheng" 
              placeholder="接种名称" clearable  :readonly="ro.jiezhongmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接种名称" prop="jiezhongmingcheng">
              <el-input v-model="ruleForm.jiezhongmingcheng" 
                placeholder="接种名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="疫苗型号" prop="yimiaoxinghao">
          <el-select :disabled="ro.yimiaoxinghao" v-model="ruleForm.yimiaoxinghao" placeholder="请选择疫苗型号">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="疫苗型号" prop="yimiaoxinghao">
	      <el-input v-model="ruleForm.yimiaoxinghao"
                placeholder="疫苗型号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="接种次数" prop="jiezhongcishu">
          <el-select :disabled="ro.jiezhongcishu" v-model="ruleForm.jiezhongcishu" placeholder="请选择接种次数">
            <el-option
                v-for="(item,index) in jiezhongcishuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="接种次数" prop="jiezhongcishu">
	      <el-input v-model="ruleForm.jiezhongcishu"
                placeholder="接种次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
	...
	shoujihaoma : false,
      ...
      ruleForm: {
        ...
        shoujihaoma: '',
          ...
          jiezhongcishuOptions: [],
      rules: {
          jiezhongmingcheng: [
                { required: true, message: '接种名称不能为空', trigger: 'blur' },
          ],
          yimiaoxinghao: [
                { required: true, message: '疫苗型号不能为空', trigger: 'blur' },
          ],
          jiezhongcishu: [
                { required: true, message: '接种次数不能为空', trigger: 'blur' },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jiezhongmingcheng'){
            this.ruleForm.jiezhongmingcheng = obj[o];
	    this.ro.jiezhongmingcheng = true;
            continue;
          }
          if(o=='yimiaoxinghao'){
            this.ruleForm.yimiaoxinghao = obj[o];
	    this.ro.yimiaoxinghao = true;
            continue;
          }
          if(o=='jiezhongcishu'){
            this.ruleForm.jiezhongcishu = obj[o];
	    this.ro.jiezhongcishu = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.shoujihaoma!=''&&json.shoujihaoma){
          ...
          this.$message.error(data.msg);
            ...
            this.jiezhongcishuOptions = "1,2,3,4".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `jiezhongxinxi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiezhongxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiezhongxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
