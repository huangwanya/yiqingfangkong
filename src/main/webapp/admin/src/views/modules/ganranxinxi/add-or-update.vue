<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="感染状态" prop="ganranzhuangtai">
          <el-select :disabled="ro.ganranzhuangtai" v-model="ruleForm.ganranzhuangtai" placeholder="请选择感染状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="感染状态" prop="ganranzhuangtai">
	      <el-input v-model="ruleForm.ganranzhuangtai"
                placeholder="感染状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="登记备注" prop="dengjibeizhu">
          <el-input v-model="ruleForm.dengjibeizhu" 
              placeholder="登记备注" clearable  :readonly="ro.dengjibeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="登记备注" prop="dengjibeizhu">
              <el-input v-model="ruleForm.dengjibeizhu" 
                placeholder="登记备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  data() {
	...
	dengjibeizhu : false,
      ...
      rules: {
          ...
          ganranzhuangtai: [
                { required: true, message: '感染状态不能为空', trigger: 'blur' },
          ],
          dengjiriqi: [
          ],
          dengjibeizhu: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiatingzhuzhi = true;
          ...
          if(o=='ganranzhuangtai'){
            this.ruleForm.ganranzhuangtai = obj[o];
	    this.ro.ganranzhuangtai = true;
            continue;
          }
          if(o=='dengjiriqi'){
	    ...
	    this.ro.dengjiriqi = true;
          ...
          if(o=='dengjibeizhu'){
            this.ruleForm.dengjibeizhu = obj[o];
	    this.ro.dengjibeizhu = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `ganranxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.ganranxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
