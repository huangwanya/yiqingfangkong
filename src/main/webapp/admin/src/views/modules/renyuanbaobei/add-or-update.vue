<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="报备编号" prop="baobeibianhao">
            <el-input v-model="ruleForm.baobeibianhao" 
                placeholder="报备编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baobeibianhao" label="报备编号" prop="baobeibianhao">
              <el-input v-model="ruleForm.baobeibianhao" 
                placeholder="报备编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="报备日期" prop="baobeiriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.baobeiriqi" 
                type="date"
                :readonly="ro.baobeiriqi"
                placeholder="报备日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baobeiriqi" label="报备日期" prop="baobeiriqi">
              <el-input v-model="ruleForm.baobeiriqi" 
                placeholder="报备日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="行程轨迹" prop="xingchengguiji">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="行程轨迹"
                  v-model="ruleForm.xingchengguiji" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xingchengguiji" label="行程轨迹" prop="xingchengguiji">
                    <span>{{ruleForm.xingchengguiji}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	jiatingzhuzhi : false,
	jiankangma : false,
	xingchengguiji : false,
	tiwen : false,
	jiancejieguo : false,
	baobeiriqi : false,
      },
      ruleForm: {
        baobeibianhao: this.getUUID(),
        xingming: '',
        xingbie: '',
        nianling: '',
        lianxifangshi: '',
  ...
  created() {
	this.ruleForm.baobeiriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='baobeibianhao'){
            this.ruleForm.baobeibianhao = obj[o];
	    this.ro.baobeibianhao = true;
            continue;
          }
          if(o=='xingming'){
	    ...
	    this.ro.jiankangma = true;
          ...
          if(o=='xingchengguiji'){
            this.ruleForm.xingchengguiji = obj[o];
	    this.ro.xingchengguiji = true;
            continue;
          }
          if(o=='tiwen'){
	    ...
	    this.ro.jiancejieguo = true;
          ...
          if(o=='baobeiriqi'){
            this.ruleForm.baobeiriqi = obj[o];
	    this.ro.baobeiriqi = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `renyuanbaobei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.renyuanbaobeiCrossAddOrUpdateFlag = false;
						 this.parent.search();
