<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="疫苗型号" prop="yimiaoxinghao">
          <el-input v-model="ruleForm.yimiaoxinghao" 
              placeholder="疫苗型号" clearable  :readonly="ro.yimiaoxinghao"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="疫苗简介" prop="yimiaojianjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="疫苗简介"
                  v-model="ruleForm.yimiaojianjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yimiaojianjie" label="疫苗简介" prop="yimiaojianjie">
                    <span>{{ruleForm.yimiaojianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shengchanshang = true;
          ...
          if(o=='yimiaojianjie'){
            this.ruleForm.yimiaojianjie = obj[o];
	    this.ro.yimiaojianjie = true;
            continue;
          }
        }
      }
