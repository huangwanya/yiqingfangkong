<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="举报编号" prop="jubaobianhao">
            <el-input v-model="ruleForm.jubaobianhao" 
                placeholder="举报编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jubaobianhao" label="举报编号" prop="jubaobianhao">
              <el-input v-model="ruleForm.jubaobianhao" 
                placeholder="举报编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="举报名称" prop="jubaomingcheng">
          <el-input v-model="ruleForm.jubaomingcheng" 
              placeholder="举报名称" clearable  :readonly="ro.jubaomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="举报名称" prop="jubaomingcheng">
              <el-input v-model="ruleForm.jubaomingcheng" 
                placeholder="举报名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	shhf : false,
      ...
      rules: {
          ...
          jubaomingcheng: [
                { required: true, message: '举报名称不能为空', trigger: 'blur' },
          ],
          jubaoneirong: [
          ],
          zhanghao: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jubaobianhao = true;
          ...
          if(o=='jubaomingcheng'){
            this.ruleForm.jubaomingcheng = obj[o];
	    this.ro.jubaomingcheng = true;
            continue;
          }
          if(o=='jubaoneirong'){
