<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="隔离类型" prop="gelileixing">
          <el-select :disabled="ro.gelileixing" v-model="ruleForm.gelileixing" placeholder="请选择隔离类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="隔离类型" prop="gelileixing">
	      <el-input v-model="ruleForm.gelileixing"
                placeholder="隔离类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="隔离时间" prop="gelishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.gelishijian" 
                type="datetime"
                :readonly="ro.gelishijian"
                placeholder="隔离时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.gelishijian" label="隔离时间" prop="gelishijian">
              <el-input v-model="ruleForm.gelishijian" 
                placeholder="隔离时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="隔离备注" prop="gelibeizhu">
          <el-input v-model="ruleForm.gelibeizhu" 
              placeholder="隔离备注" clearable  :readonly="ro.gelibeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="隔离备注" prop="gelibeizhu">
              <el-input v-model="ruleForm.gelibeizhu" 
                placeholder="隔离备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiatingzhuzhi = true;
          ...
          if(o=='gelileixing'){
            this.ruleForm.gelileixing = obj[o];
	    this.ro.gelileixing = true;
            continue;
          }
          if(o=='gelishijian'){
	    ...
	    this.ro.gelishijian = true;
          ...
          if(o=='gelibeizhu'){
            this.ruleForm.gelibeizhu = obj[o];
	    this.ro.gelibeizhu = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `gelixinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.gelixinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
