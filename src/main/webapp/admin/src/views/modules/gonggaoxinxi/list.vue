        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="公告标题">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="gonggaofengmian"
                   :header-align="contents.tableAlign"
                    width="200"
                    label="公告封面">
                    <template slot-scope="scope">
                      <div v-if="scope.row.gonggaofengmian">
                        <img :src="$base.url+scope.row.gonggaofengmian.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
