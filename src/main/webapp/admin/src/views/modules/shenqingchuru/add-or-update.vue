<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体温信息" prop="tiwenxinxi">
          <el-input v-model="ruleForm.tiwenxinxi" 
              placeholder="体温信息" clearable  :readonly="ro.tiwenxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="体温信息" prop="tiwenxinxi">
              <el-input v-model="ruleForm.tiwenxinxi" 
                placeholder="体温信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiankangma = true;
          ...
          if(o=='tiwenxinxi'){
            this.ruleForm.tiwenxinxi = obj[o];
	    this.ro.tiwenxinxi = true;
            continue;
          }
          if(o=='xingchengguiji'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shenqingchuru/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shenqingchuruCrossAddOrUpdateFlag = false;
						 this.parent.search();
