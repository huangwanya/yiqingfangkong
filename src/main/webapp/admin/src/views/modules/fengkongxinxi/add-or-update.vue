<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="封控名称" prop="fengkongmingcheng">
          <el-input v-model="ruleForm.fengkongmingcheng" 
              placeholder="封控名称" clearable  :readonly="ro.fengkongmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="封控名称" prop="fengkongmingcheng">
              <el-input v-model="ruleForm.fengkongmingcheng" 
                placeholder="封控名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="封控内容" prop="fengkongneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="封控内容"
                  v-model="ruleForm.fengkongneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fengkongneirong" label="封控内容" prop="fengkongneirong">
                    <span>{{ruleForm.fengkongneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	fengkongmingcheng : false,
	louhao : false,
	zhuangtai : false,
	fengkongneirong : false,
	gengxinriqi : false,
      },
      ruleForm: {
        fengkongmingcheng: '',
      ...
      rules: {
          fengkongmingcheng: [
                { required: true, message: '封控名称不能为空', trigger: 'blur' },
          ],
          louhao: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='fengkongmingcheng'){
            this.ruleForm.fengkongmingcheng = obj[o];
	    this.ro.fengkongmingcheng = true;
            continue;
          }
          if(o=='louhao'){
	    ...
	    this.ro.zhuangtai = true;
          ...
          if(o=='fengkongneirong'){
            this.ruleForm.fengkongneirong = obj[o];
	    this.ro.fengkongneirong = true;
            continue;
          }
          if(o=='gengxinriqi'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `fengkongxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.fengkongxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
