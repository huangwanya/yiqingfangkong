<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jumin'"  label="账号" prop="zhanghao">
          <el-input v-model="ruleForm.zhanghao" readonly              placeholder="账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jumin'"  label="姓名" prop="xingming">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jumin'"  label="手机号码" prop="shoujihaoma">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jumin'"  label="家庭住址" prop="jiatingzhuzhi">
          <el-input v-model="ruleForm.jiatingzhuzhi"               placeholder="家庭住址" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='jumin'" label="相片" prop="xiangpian">
          <file-upload
          tip="点击上传相片"
          action="file/upload"
          :limit="3"
          ...
          @change="juminxiangpianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jumin'"  label="邮箱" prop="email">
...
export default {
  ...
  methods: {
    juminxiangpianUploadChange(fileUrls) {
    ...
    onUpdateHandler() {
      ...
      if( 'jumin' ==this.flag && this.ruleForm.email&&(!isEmail(this.ruleForm.email))){
