<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于SSM的社区疫情防控平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='jumin'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='jumin'">
			...
			<el-form-item label="手机号码" class="input" v-if="tableName=='jumin'">
			...
			<el-form-item label="家庭住址" class="input" v-if="tableName=='jumin'">
			  <el-input v-model="ruleForm.jiatingzhuzhi" autocomplete="off" placeholder="家庭住址"  />
			</el-form-item>
			<el-form-item label="邮箱" class="input send-code" v-if="tableName=='jumin'">
			...
			<el-form-item label="验证码" class="input" v-if="tableName=='jumin'">
